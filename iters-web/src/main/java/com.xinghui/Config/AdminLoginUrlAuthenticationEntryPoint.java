...
public class AdminLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
     ...
     *                     URL.
     */
    public AdminLoginUrlAuthenticationEntryPoint(String loginFormUrl) {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        json.put("code", HttpCodeEnum.deny.getValue());
        json.put("message", HttpCodeEnum.deny.getDesc());
        json.put("data", "");
